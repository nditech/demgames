...
class AnswerInfoPopup extends Component {
  ...
  render() {
    const {
      open, handleClose, imageUrl, answerStatus, message, currentQuestionScore,
    } = this.props;
    return (
      <Dialog
        ...
        <DialogContent>
          <DialogContentText className="points-status" id="dialog-slide-description">
            ...
            {!answerStatus && (
              <button
                type="submit"
                className="show-right-answer-button"
