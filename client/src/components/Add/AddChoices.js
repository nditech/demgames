...
const AddChoices = () => {
  ...
  const handleReset = () => {
    setFormData({
      ...formData, choicestatement: '', choicedescription: '', weight: '', isanswer: '', questionid: '',
    });
  };
        ...
        <div className="col-md-8">
          <form className="text-center border border-light p-5" onSubmit={e => handleSubmit(e)}>
            ...
            <input
              ...
              type="text"
              name="choicestatement"
              value={choicestatement}
              onChange={e => handleChange(e)}
            />
            <br />
            <textarea
            ...
            <div className="text-center mt-12">
              ...
              {' '}
              |
              <button className="btn btn-warning" type="button" onClick={e => handleReset(e)}>Reset</button>
            </div>
          </form>
        </div>
      </div>
