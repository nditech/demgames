export const gameData = [
		...
		levels: [
			{
				...
				questions: [
					...
					},
					{
						...
						question: 'Ethos',
						options: [
							'This is the Greek word for ethics or character and focuses on demonstrating the debaters’ trustworthiness, dependability or preparedness.',
							"The process of attacking an opponent's arguments",
							'This is the Greek word that means both experience and suffering and during a debate focuses on convincing the audience with emotion.',
							'A controversial statement that a debater supports or refutes with evidence and reasoning.'
						],
					...
					},
					{
						...
						question: 'Pathos',
						options: [
							'This is the Greek word that means both experience and suffering and during a debate it focuses on convincing the audience with emotion.',
							"The process of attacking an opponent's arguments",
							'This is the Greek word that means both experience and suffering and during a debate focuses on convincing the audience with emotion.',
							'A controversial statement that a debater supports or refutes with evidence and reasoning.'
						],
					...
					},
					{
						...
						question: 'Logos',
						options: [
							'This is the Greek word for logic and focuses on the message and appeal to authority or credibility by offering expertise, research, or data to support arguments.',
							"The process of attacking an opponent's arguments",
							'This is the Greek word that means both experience and suffering and during a debate focuses on convincing the audience with emotion.',
							'A controversial statement that a debater supports or refutes with evidence and reasoning.'
						],
					...
					{
						id: 9,
						question: 'Structural Barrier',
						options: [
							'These are laws, supreme court decisions, and executive branch policies that would keep a new policy from existing.',
							"The process of attacking an opponent's arguments",
							'This is the Greek word that means both experience and suffering and during a debate focuses on convincing the audience with emotion.',
							'A controversial statement that a debater supports or refutes with evidence and reasoning.'
						],
					...
					{
						id: 10,
						question: 'Attitudinal Barrier',
						options: [
							'These are mindsets that would block certain policies or laws. The president (and cabinet), congressional leaders, court justices, interest groups, and the public all have the power to keep policies from existing.',
							"The process of attacking an opponent's arguments",
							'This is the Greek word that means both experience and suffering and during a debate focuses on convincing the audience with emotion.',
							'A controversial statement that a debater supports or refutes with evidence and reasoning.'
						],
				...
				questions: [
					{
						id: 1,
						question:
							'The government should implement a tax on pollution to create a healthier environment.',
						options: [
					...
					{
						id: 2,
						question: 'Teachers should be paid a higher wage.',
						options: [
					...
					{
						id: 3,
						question: 'The death penalty is an unjustified method of punishment.',
						options: [
				...
				questions: [
					{
						id: 1,
						question:
							'What component of the argument (i.e. affirmation, evidence, reasoning) doesn’t match? \n Topic: Death Penalty',
						options: [
	...
	{
		id: 3,
		name: 'Finding flaws in Argument',
		style: 'orange',
		type: 'scenario',
		levels: [
			{
				...
				questions: [
					{
						id: 1,
						question:
							'Resolution: There should be a youth quota in the national legislative body.You are arguing the affirmative. Your opponents begin their argument by saying the following: Youth quota does not exist because adult decision makers already represent youth concerns. What counterargument would you present?',
						options: [
							{
								option:
					...
					},
					{
						id: 3,
						question:
							'Your opponents note that in the past 5 assembly meetings, adults have discussed multiple youth issues. Furthermore, one anecdotal example does not refute this evidence and cannot be applied to the population of adult decision-makers as a whole. How do you respond?',
						options: [
							{
								option:
					...
					},
					{
						id: 4,
						question:
							'Your opponent acknowledges that you are correct about past meetings, however, in the last meeting there was a new amendment passed on youth unemployment. This demonstrates that decision makers are incorporating youth concerns into decision making,',
						options: [
							{
								option:
					...
					},
					{
						id: 5,
						question:
							'Your opponent responds by saying change takes time and decision makers in the national assembly have a responsibility to more than just young people who only represent 22% of the population. Positive change for all of society will also mean change for young people.',
						options: [
							{
								option:
					...
					},
					{
						id: 6,
						question:
							'Your opponent responds by saying youth quotas are an ineffective use of assembly seats. Establishing a quota is the opposite of democracy and does not guarantee that a quality, capable candidate will be chosen. How do you respond?',
						options: [
							{
								option:
									'Youth candidates will still have expectations and requirements to ensure a quality, capable candidate can be voted for in a democratic process. ',
					...
					},
					{
						id: 9,
						question:
							'Your opponents respond by stating that there are other ways to capture youth concerns--through national surveys for example. How would you respond? ',
						options: [
							{
								option:
					...
					},
					{
						id: 10,
						question:
							'Your opponents acknowledge the possibility of sampling bias but conclude that youth quotas also do not represent ALL youth concerns. There may be bias among those chosen to serve in the national legislative body.',
						options: [
							{
								option:
					...
					},
					{
						id: 11,
						question:
							'Your opponent states that there are other mechanisms in place that ensure accountability and capture the voices of all citizens. The national legislative body recently voted on a measure to increase youth centers in rural communities based on recommendations from community members. How do you respond?',
						options: [
							{
								option:
					...
					},
					{
						id: 12,
						question:
							'Your opponent states that unemployment and healthcare are priorities for the current administration, as evidenced by the 20% reduction in homelessness and the bill passed for universal healthcare. This demonstrates that youth concerns are being addressed by the national agenda. You believe your opponent’s argument has merit and decide to conduct more research.',
						options: [
							{
								option: '',
					...
					},
					{
						id: 13,
						question:
							'Your opponent states that outcomes for youth are measured by outcomes for all of society. For example, in the past year there has been a 20% decrease in homelessness and a bill passed for universal healthcare. How do you respond?',
						options: [
							{
								option:
					...
					},
					{
						id: 14,
						question:
							'Your opponent acknowledges the strength of your argument and the need to do further research to respond.',
						options: [
							{
								option: '',
								linked_question: null
