...
import { fetchScoreDetail, updateRouteDetail, setPlayersDetails } from "../../components/ProfileInfo/action";
...
class LandingPage extends React.Component {
        ...
        componentDidMount() {
                ...
                let cohort_name = (auth0.getCohort().split("/landingpage")[0].split("/")[1]||this.props.routeDetail.name);
                console.log("Cohort Name from " + cohort_name);
                // fetch('./moduleData.json')
                fetch(config.baseUrl + `/api/v2/game/${this.props.routeDetail.name}`, {
                        method: "get",
                        headers: {
                    ...
                    fetch(config.baseUrl + "/user/findOne/" + authDetail.player_email, {
                        ...
                        .then(data => {
                            ...
                            else
                            {
                                ...
                                console.log("Data of the Player is set"+ JSON.stringify(this.props.selectedPlayer));
                            }
                        })
                        .catch(error => {
                            console.log(error);
                            ...
                            <div className = "game-type-card-container" > {
                                ...
                                gameData.map((modules, key) => ( <
                                    ...
                                    player_email = {
                                        ...
                                        "default" : this.props.player_email
                                    }
                                    />
                                ))
                              } 
        ...
        const mapStateToProps = state => ({
            player_given_name: state.authDetail.player_given_name,
            player_picture: state.authDetail.player_picture,
        ...
        LandingPage.propTypes = {
            ...
            setPlayersDetails: PropTypes.func,
